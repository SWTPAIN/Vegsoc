defmodule Vegsoc do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(Endpoint, []),
      # Start your own worker by calling: Vegsoc.Worker.start_link(arg1, arg2, arg3)
      # worker(Vegsoc.Worker, [arg1, arg2, arg3]),
    ]

    # See http://elixir-lang.org/docs/stable/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: Vegsoc.Supervisor]
